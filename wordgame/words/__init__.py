...
WORD_SETS = {
    ...
    "scrabble7": WordSet(scrabble7, 7, 3000, "saltier"),
    "scrabble8": WordSet(scrabble8, 8, 3000, "notaries"),
    "dictionary5": WordSet(dictionary5, 5, 2000, "aries"),
    "dictionary6": WordSet(dictionary6, 6, 3000, "salter"),
    "dictionary7": WordSet(dictionary7, 7, 3000, "saltier"),
    "dictionary8": WordSet(dictionary8, 8, 3000, "notaries"),
}
